...
const ContactForm = () => {
    ...
    return <div>
        ...
        <form ref={form} className={classes.form} onSubmit={onSubmitForm}>
            <input type="email" name="email" placeholder="Adresse mail *" required className={classes.form__input + ' form__input'}/>
            <input type="text" name="objet" placeholder="Objet *" required className={classes.form__input + ' form__input'}/>
            <input type="text" name="message" placeholder="Votre message *" required className={classes.form__input + ' form__input'}/>
